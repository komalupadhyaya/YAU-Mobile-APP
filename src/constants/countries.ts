...
export const countries: Country[] = [
  ...
  { name: 'Saint Kitts and Nevis', flag: '🇰🇳', code: 'KN', dialCode: '+1' },
  { name: 'Saint Lucia', flag: '🇱🇨', code: 'LC', dialCode: '+1' },
  { name: 'Saint Vincent and the Grenadines', flag: '🇻🇨', code: 'VC', dialCode: '+1' },
